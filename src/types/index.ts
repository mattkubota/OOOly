...
// WHY: Users can only select certain day types
// WHAT: Defines valid user-selectable PTO day types
// NOTE: 'weekend' is handled as a status, not a selectable type
export type DayType = 'full' | 'half' | 'holiday';
